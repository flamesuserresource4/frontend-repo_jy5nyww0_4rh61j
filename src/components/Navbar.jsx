    ...
    <header className="w-full sticky top-0 z-30 backdrop-blur border-b border-white/20 bg-white/60 dark:bg-neutral-900/60">
      <nav className="max-w-6xl mx-auto flex items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-3">
          <button className="hidden sm:inline-flex px-3 py-2 text-sm rounded-md text-neutral-700 dark:text-neutral-200 hover:bg-neutral-100 dark:hover:bg-neutral-800 transition">
            Pricing
          </button>
          <button className="hidden sm:inline-flex px-3 py-2 text-sm rounded-md text-neutral-700 dark:text-neutral-200 hover:bg-neutral-100 dark:hover:bg-neutral-800 transition">
            Templates
          </button>
          <button className="inline-flex items-center gap-2 px-3 py-2 text-sm rounded-md bg-neutral-900 text-white hover:bg-neutral-800 transition">
