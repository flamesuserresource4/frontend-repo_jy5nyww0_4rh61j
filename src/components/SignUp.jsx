...
export default function SignUp() {
  ...
  return (
    <section id="signup" className="py-20 bg-white dark:bg-neutral-950">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            <h2 className="text-3xl sm:text-4xl font-bold text-neutral-900 dark:text-white">Create your account</h2>
            <p className="mt-3 text-neutral-600 dark:text-neutral-300">Start building better resumes with multi‑model AI, templates, and one‑click export.</p>
            <div className="mt-6 flex items-center gap-3 text-sm text-neutral-600 dark:text-neutral-300">
              <Shield className="h-4 w-4 text-emerald-500" />
              <span>Your API keys never leave your browser during generation.</span>
            </div>
          </div>
          ...
          <div className="rounded-xl border border-black/10 dark:border-white/10 bg-white/70 dark:bg-neutral-900/60 backdrop-blur p-6 shadow-sm">
            <form onSubmit={onSubmit} className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-200">Confirm password</label>
                <div className="mt-1 relative">
                  <Lock className="absolute left-3 top-2.5 h-4 w-4 text-neutral-400" />
                  <input
                    type={showPassword ? 'text' : 'password'}
            ...
            <div className="mt-4 text-sm text-center text-neutral-600 dark:text-neutral-300">
              Already have an account? <a href="#signin" className="text-indigo-600 hover:text-indigo-700 dark:text-indigo-400">Sign in</a>
            </div>
          </div>
        </div>
      </div>
